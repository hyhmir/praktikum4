...
Namen vaje je spoznavanje uporabe funkcijskega generatorja in osciloskopa ter razumevanje odziva različnih elektronskih elementov. Odziv je lahko linearen in odvisen od frekvence, kot je pri idealnem kondenzatorju in tuljavi, Lahko je nelinearen (polprevodniški elementi) ali pa bolj zapleten če je element sestavljen iz različnih sklopov kot je naprimer tuljava z železnim jedrom.
"""

# ╔═╡ e154b0d5-28a6-4e8e-a8a8-c99b85c19bfe
md"""
Pri vaji smo uporabljali naslednjo postavitev: 
"""

# ╔═╡ 2d178712-14b2-46e3-a83e-c1ddc7da7323
load("porocilo/vezje.png")

# ╔═╡ 2c23d178-fead-43c7-ab0a-b93e0bc7bf6a
md"""
Ločilni transformator dovoljuje da ozemljimo poljubno točko na krogu. Če bi uporabljali tako imenovani plavajoči (floating) izhod iz funkcijskega generatorja, ločilni transformator ne bi bil potreben.
"""
...
- Funkcijski generator, ločilni transformator,
- vezje s komponentami, baterija 9V, NiMH akumolator 1.2V, žice,
...
- Izmerite karakteristike $I(U)$ upornika, kondenzatorja, tuljave, diode, Zenerjeve diode, treh svetlečih diod, 9V alkalne baterije in akumulatorja.
- Določite upornost upornika, kapaciteto kondenzatorja, induktivnost tuljave, karakteristične točke nelinearnih elementov, nazivno napetost in notranjo upornost baterije in akumulatorja
"""
