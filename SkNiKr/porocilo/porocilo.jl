...
# ╔═╡ 15575c13-9bca-4c15-b79e-55317415e350
md"""
...
# ╔═╡ a2212ed1-1258-4f65-84c3-37a1eca1c9c8
md"""
## Pripomočki

- Digitalni osciloskop,
- funkcijski generator napetosti, namizni multimeter,
- nihajna kroga in kabli, USB ključek,
- prenosnik z ustrezno programsko opremo.

"""

# ╔═╡ ba79cd81-5189-4b80-a01e-1efefd789c42
md"""
## Naloga

1. Izmerite časovni potek napetosti na obeh krogih pri vzbujanju s stopničastim signalom za vse različne sklopitve,
2. Izmerite frekvenčno karakteristiko enega nihajnega kroga in določite dobroto $Q$
3. Izmerite frekvenčo karakteristiko sklopljenih nihajnih krogov z meritvijo odziva drugega kroga za vsak $C_0$ in izmerite razliko lastnih krožnih frekvenc
"""

# ╔═╡ a7a6c027-a9d6-46e0-a3eb-d9f2a7176140
md"""
...
# ╔═╡ e47ec6f8-df09-49e4-826d-608316e8ada6
load("/home/hyh/Documents/praktikum4/SkNiKr/porocilo/vezje.png")

# ╔═╡ 5ddcc67e-7a7f-4492-b14f-08b92fb94562
